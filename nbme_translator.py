...
SOURCE_DIR = os.path.join('data', 'parsed_txt', 'nbme')
DEST_DIR = os.path.join('data', 'outputs', 'trans', f'nmbe_{MODEL_DISP_NAME}')
mkdir(DEST_DIR)
...
if __name__ == "__main__":
    ...
    stat_file_path = os.path.join(STAT_DIR, f'nbme_stat_{MODEL_DISP_NAME}.jsonl')
